...
@WebServlet("/adminReport.do")
public class TotalReportServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public TotalReportServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalContent= 0;
		if ( sort > 4 ) {
//			totalContent = aService.reportSortCount(sort);
		} else {
			totalContent = aService.reportTotalCount();
		}
		...
		ArrayList<AdminReport> cList = aService.reportList(currentPage, limit);
