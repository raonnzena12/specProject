...
SELECT * FROM (SELECT ROWNUM RNUM, A.* FROM (SELECT m.*, USER_NAME FROM COMMENTT m JOIN USER_TABLE U ON ( MCO_USERNO = U.USER_NO )  ORDER BY MCO_REGDATE DESC) A) WHERE RNUM BETWEEN 1 AND 10;